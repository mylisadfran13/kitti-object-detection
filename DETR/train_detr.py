...
def get_model(num_classes=8):
    model = torchvision.models.detection.detr(pretrained=True, num_classes=num_classes)
    return model
...
if __name__ == "__main__":
    ...
    plt.plot(range(1, 11), losses, marker='o', color='#BC4B51')
    plt.xlabel('Эпоха')
    plt.ylabel('Loss')
    plt.title('DETR Training Loss')
    plt.grid(True)
    plt.savefig('detr_loss.png', dpi=150)